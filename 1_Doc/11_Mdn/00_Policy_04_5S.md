...
- [在庫管理の見える化とは](https://www.smartmat.io/column/fives)
...
製造業や建設現場で徹底されている**5S（整理・整頓・清掃・清潔・しつけ）**は、物理的な安全だけでなく、作業効率と品質を最大化するための知恵です。  
...
- [静的解析ツール](11_Dev_07_StaticAnalysis.md)
...
[仕事のミスをなくす５０のしかけ改善](../13_Ref/00_Policy/00_Policy_04_5S_udm_ミス防止_仕事のミスをなくす５０のしかけ改善レジュメ.pdf)<sup>1</sup>
